  ...
  return (
    <div className="px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/admin/bookings" className="p-2 rounded-full hover:bg-white/10 transition-colors -ml-2">
          ←
        </Link>
        <div>
          ...
          <p className="text-white/40 text-xs">
            {booking.client_name} · {(booking.services as { name: string } | null)?.name} ·{' '}
