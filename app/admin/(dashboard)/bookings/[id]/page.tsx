    ...
    <div className="px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[#8a7f7a] text-xs">{booking.client_name} · {(booking.services as { name: string } | null)?.name} · {new Date((booking.appointment_date || '').slice(0, 10) + 'T12:00:00').toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</p>
        </div>
      </div>
      <BookingDetailClient
        booking={booking}
